...
public class RandomDepthFirstPaths {
    ...
    public void randomNonrecursiveDFS(Graph G) {
		// TODO
        marked = new boolean[G.V()];
        LinkedList<Integer>[] vertex = new LinkedList[G.V()];
        for(int k = 0; k < G.V(); k++){
            vertex[k] = G.adj(k);
            Collections.shuffle(vertex[k]);
        }
    ...
    public static void main(String[] args) {
        ...
        RandomDepthFirstPaths random = new RandomDepthFirstPaths(G, root);
        random.randomDFS(G);
        for (int a : random.edgeTo)
            System.out.print(a + " ");
        System.out.println();*/
    }
